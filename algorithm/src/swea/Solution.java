	...
	public static void dfs(Player player) {
		...
		if(player.myRowPosition == 99) {
			if(player.myCount <= minCount) {
				...
				System.out.println("player.myCount : " + player.myCount + "  minCount : " + minCount);
				System.out.println("bestStartPoint : " + bestStartPoint);
				return;
			}else return;
		}
...
//				System.out.println("현재위치 : " + player.myRowPosition + ", " + player.myColPosition + "   다음위치 : " + nextRow + ", " + nextCol);
